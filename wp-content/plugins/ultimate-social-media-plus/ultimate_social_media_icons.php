...
define('SFSI_PLUS_ALLICONS',serialize(array("rss","email","facebook","twitter","youtube","linkedin",
...
if(!get_option('sfsi_plus_pluginVersion') || get_option('sfsi_plus_pluginVersion') < 3.16)
{
